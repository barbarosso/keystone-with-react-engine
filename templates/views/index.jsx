		...
		<Default {...props}>
			<div className="container">
				<div className="jumbotron">
					...
					<p>
						Visit the{' '}
						<a href="http://keystonejs.com/guide" target="_blank">
							Getting Started
						</a>{' '}
					...
					{props.user && props.user.canAccessKeystone ? (
						...
						<p>
							...
							<strong>user@keystonejs.com</strong> and the password{' '}
							<strong>admin</strong>.
							<br />
							<a
					...
					<p>
						Remember to{' '}
						<a href="https://github.com/keystonejs/keystone" target="_blank">
					...
					<button
						...
						onClick={() =>
							alert(
								'An alert from the frontend! with ops, the section is: ' +
									props.section
							)
						}
					>
